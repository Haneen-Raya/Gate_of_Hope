 ...
 * to filter housing type based on request inputs.
 *
 ...
 */
class HousingTypeBuilder extends Builder
{
    /**
    ...
    /**
     * Apply dynamic filters on housing types.
     *
