...
namespace Modules\Entities\Providers;
...
use Modules\Entities\Policies\DonorReportPolicy;
...
class EntitiesServiceProvider extends ServiceProvider
{
    ...
    protected string $nameLower = 'entities';
    ...
    public function boot(): void
    {
        ...
        Gate::policy(DonorReport::class, DonorReportPolicy::class);
